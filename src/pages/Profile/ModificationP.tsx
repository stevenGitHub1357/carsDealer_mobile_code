// src/pages/ModificationP.tsx
import React, { useState } from 'react';
import { IonContent, IonPage, IonInput, IonButton, IonLabel, IonDatetime, IonSelect, IonSelectOption, IonButtons, IonBackButton, IonTitle, IonHeader, IonMenuButton, IonToolbar } from '@ionic/react';
import { useHistory } from 'react-router';

const ModificationP: React.FC = () => {
    ...
    <IonPage>
      <IonHeader>
        <IonToolbar>
          ...
          <IonButtons>
              <IonMenuButton/>
              <IonTitle> Modification du profile </IonTitle>
          </IonButtons>
      ...
      <IonContent>   
        <div className="ion-padding">
          ...
          <IonButton expand="full" onClick={handleSaveModificationP}>
